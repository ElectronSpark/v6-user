    ...
    int fd, struct d3dkmthandle device, struct winluid adapter_luid)
{
    ...
    int d3d12_display_bind_provider_no_send_preflight_pass = 0;
    int d3d12_display_bind_provider_no_send_source_match = 0;
    int d3d12_display_bind_provider_no_send_resource_match = 0;
    ...
    int d3d12_display_bind_authority_chain_pass = 0;
    int dda_nouveau_d3d12_bridge_disjoint_pass = 0;
    ...
    d3d12_display_bind_provider_pending_publication_pass =
        ...
        stats_after.dxg_display_bind_provider_pending_process_namespace_valid == 1 &&
        stats_after.dxg_display_bind_provider_pending_device_hmgr_index_unique_valid == 1 &&
        stats_after.dxg_display_bind_provider_pending_resource_hmgr_index_unique_valid == 1 &&
        stats_after.dxg_display_bind_provider_pending_allocation_hmgr_index_unique_valid == 1 &&
        ...
        stats_after.dxg_display_bind_provider_pending_shared_parent_id != 0 &&
        stats_after.dxg_display_bind_provider_pending_shared_parent_refs != 0 &&
        stats_after.dxg_display_bind_provider_pending_shared_parent_children != 0 &&
        stats_after.dxg_display_bind_provider_pending_shared_parent_fd_refs != 0 &&
        stats_after.dxg_display_bind_provider_pending_shared_parent_global_share != 0 &&
        stats_after.dxg_display_bind_provider_pending_shared_parent_host_nt_handle != 0 &&
        stats_after.dxg_display_bind_provider_pending_opened_child_parent_id_match == 1 &&
        stats_after.dxg_display_bind_provider_pending_opened_child_global_share_match == 1 &&
        stats_after.dxg_display_bind_provider_pending_opened_child_sealed_generation_match == 1 &&
        ...
        stats_after.dxg_display_bind_provider_pending_shared_parent_global_share_match == 1 &&
        (stats_after.dxg_display_bind_provider_pending_syncobject_object_ref_active == 0 ||
         (stats_after.dxg_display_bind_provider_pending_syncobject_shared_owner_present == 1 &&
          stats_after.dxg_display_bind_provider_pending_syncobject_monitored_fence == 1 &&
          stats_after.dxg_display_bind_provider_pending_syncobject_fence_value != 0 &&
          stats_after.dxg_display_bind_provider_pending_syncobject_fence_cpu_va_present == 1 &&
          stats_after.dxg_display_bind_provider_pending_syncobject_fence_gpu_va_present == 1 &&
          stats_after.dxg_display_bind_provider_pending_syncobject_fence_kva_present == 1 &&
          (stats_after.dxg_display_bind_provider_pending_syncobject_real_fence_gpu_va_present == 1 ||
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_gpu_va_alias_gap == 1) &&
          stats_after.dxg_display_bind_provider_pending_syncobject_fence_map_size != 0)) &&
        ...
        stats_after.nouveau_pci_native_present_credit == 0 &&
        no_present_credit && hyperv_gate;
    d3d12_display_bind_provider_no_send_source_match =
        stats_after.dxg_display_bind_provider_pending_source_generation != 0 &&
        stats_after.dxg_display_bind_provider_pending_source_generation ==
            stats_after.dxg_display_bind_pending_last_source_generation;
    d3d12_display_bind_provider_no_send_resource_match =
        stats_after.dxg_display_bind_provider_pending_resource_generation != 0 &&
        stats_after.dxg_display_bind_provider_pending_resource_generation ==
            stats_after.dxg_display_bind_pending_last_resource_generation;
    d3d12_display_bind_provider_no_send_preflight_pass =
        stats_after_rc == 0 &&
        stats_after.dxg_display_bind_provider_submits >
            stats_before.dxg_display_bind_provider_submits &&
        stats_after.dxg_display_bind_request_metadata_complete == 1 &&
        stats_after.dxg_display_bind_provider_pin_revalidated == 1 &&
        stats_after.dxg_display_bind_provider_preflight_ready == 1 &&
        d3d12_display_bind_provider_no_send_source_match &&
        d3d12_display_bind_provider_no_send_resource_match &&
        stats_after.dxg_display_bind_provider_send_attempts == 0 &&
        stats_after.dxg_display_bind_provider_send_blocked_no_host_abi >
            stats_before.dxg_display_bind_provider_send_blocked_no_host_abi &&
        stats_after.dxg_display_bind_provider_completion_demux_attempts == 0 &&
        stats_after.dxg_display_bind_provider_completion_demux_blocked_no_contract >
            stats_before.dxg_display_bind_provider_completion_demux_blocked_no_contract &&
        stats_after.dxg_display_bind_host_saw_packet == 0 &&
        stats_after.dxg_display_bind_transport_source ==
            FB_GPU_DXG_DISPLAY_BIND_SOURCE_NONE &&
        stats_after.dxg_display_bind_provider_no_host_abi == 1 &&
    ...
    host_display_bind_source_catalog_pass =
        ...
        stats_after.dxg_scanout_bind_completion_successes ==
            stats_before.dxg_scanout_bind_completion_successes &&
        no_present_credit && hyperv_gate;
    d3d12_display_bind_authority_chain_pass =
        host_display_bind_source_catalog_pass &&
        d3d12_display_bind_host_abi_discovery_pass &&
        d3d12_display_bind_provider_no_send_preflight_pass &&
        stats_after.dxg_display_bind_provider_transport_pending_id == 0 &&
...
out:
    ...
    printf("d3d12_display_bind_provider_pending_publication_matrix "
           ...
           stats_after.dxg_display_bind_provider_pending_process_namespace_valid,
           stats_after.dxg_display_bind_provider_pending_hmgr_index_unique_valid,
           stats_after.dxg_display_bind_provider_pending_device_hmgr_index_unique_valid,
           stats_after.dxg_display_bind_provider_pending_resource_hmgr_index_unique_valid,
           stats_after.dxg_display_bind_provider_pending_allocation_hmgr_index_unique_valid,
           ...
           stats_after.dxg_display_bind_provider_pending_shared_parent_id,
           stats_after.dxg_display_bind_provider_pending_shared_parent_refs,
           stats_after.dxg_display_bind_provider_pending_shared_parent_children,
           stats_after.dxg_display_bind_provider_pending_shared_parent_fd_refs,
           stats_after.dxg_display_bind_provider_pending_shared_parent_host_nt_refs,
           stats_after.dxg_display_bind_provider_pending_shared_parent_child_refs,
           stats_after.dxg_display_bind_provider_pending_shared_parent_global_share,
           stats_after.dxg_display_bind_provider_pending_shared_parent_host_nt_handle,
           stats_after.dxg_display_bind_provider_pending_opened_child_parent_id_match,
           stats_after.dxg_display_bind_provider_pending_opened_child_global_share_match,
           stats_after.dxg_display_bind_provider_pending_opened_child_sealed_generation_match,
           ...
           stats_after.dxg_display_bind_provider_pending_shared_parent_global_share_match,
           stats_after.dxg_display_bind_provider_pending_syncobject_object_ref_active,
           stats_after.dxg_display_bind_provider_pending_syncobject_shared_owner_present,
           stats_after.dxg_display_bind_provider_pending_syncobject_monitored_fence,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_value,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_cpu_va_present,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_gpu_va_present,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_kva_present,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_gpu_va_alias_gap,
           stats_after.dxg_display_bind_provider_pending_syncobject_real_fence_gpu_va_present,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_gpu_va_source,
           stats_after.dxg_display_bind_provider_pending_syncobject_fence_map_size,
    ...
    printf("d3d12_display_bind_provider_no_send_preflight_matrix "
           ...
           d3d12_display_bind_provider_no_send_resource_match ?
               "PASS" : "FAIL",
           stats_after.dxg_display_bind_provider_preflight_ready,
           stats_after.dxg_display_bind_provider_send_attempts,
           stats_after.dxg_display_bind_provider_send_blocked_no_host_abi -
               stats_before.dxg_display_bind_provider_send_blocked_no_host_abi,
           stats_after.dxg_display_bind_provider_completion_demux_attempts,
           stats_after.dxg_display_bind_provider_completion_demux_blocked_no_contract -
               stats_before.dxg_display_bind_provider_completion_demux_blocked_no_contract,
           stats_after.dxg_display_bind_host_saw_packet,
           display_bind_transport_source_name(
    ...
    printf("d3d12_native_completion_consumer_escrow_matrix "
    ...
    printf("d3d12_dda_nouveau_separate_display_not_bind_matrix "
           ...
           d3d12_dda_nouveau_separate_display_not_bind_pass ? "PASS" :
               "FAIL");
    printf("dda_nouveau_d3d12_bridge_disjoint_matrix "
           "dda_backend_flag=%u dda_pci_display_present=%lu "
    ...
    printf("d3d12_display_bind_host_abi_discovery_matrix "
           ...
           stats_after.dxg_display_bind_completed_id,
           d3d12_display_bind_host_abi_discovery_pass ? "PASS" : "FAIL");
    printf("d3d12_display_bind_authority_chain_matrix "
           ...
           stats_after.dxg_display_bind_completed_id,
           (backend.flags & FB_GPU_BACKEND_F_OPENGL_SUBMIT) != 0,
           d3d12_display_bind_authority_chain_pass ? "PASS" : "FAIL");
